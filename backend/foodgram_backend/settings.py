...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-aa1*%1a11aa1a#1!a1*$aaaa1)aaaaa1aa!1a-a*aa1!a$-a1$')
...
FRONTEND_RECIPE_ENDPOINT = 'recipes'
...
} if os.getenv('USE_SQLITE_DB', 'True') == 'True' else {
    'default': {
